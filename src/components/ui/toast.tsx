...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed bottom-20 left-1/2 -translate-x-1/2 z-[100] flex flex-col gap-2 w-auto max-w-[90vw] sm:bottom-6 sm:left-auto sm:right-6 sm:translate-x-0 sm:max-w-[380px]",
      className
    )}
    {...props}
  />
