-- SOLUTION 100% FIABLE: Fonction SQL atomique pour timeout
-- Remplace complètement le cron JavaScript par une fonction SQL native
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- Log pour debug
      RAISE NOTICE 'TIMEOUT PROCESSED: % (%) - %Ⓐ refunded', 
...
COMMENT ON FUNCTION process_expired_activations() IS '100% reliable timeout processing - single atomic transaction per activation';