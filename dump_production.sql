...
CREATE OR REPLACE FUNCTION "public"."update_wave_payment_proofs_updated_at"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
  NEW.updated_at = NOW();
...
ALTER FUNCTION "public"."update_wave_payment_proofs_updated_at"() OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."contact_settings" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    "instagram" "text" DEFAULT '@onesms.sn'::"text"
);
...
CREATE TABLE IF NOT EXISTS "public"."wave_payment_proofs" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "wave_payment_proofs_status_check" CHECK (("status" = ANY (ARRAY['pending'::"text", 'validated'::"text", 'rejected'::"text"])))
);


ALTER TABLE "public"."wave_payment_proofs" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."wave_payment_proofs"
    ADD CONSTRAINT "wave_payment_proofs_pkey" PRIMARY KEY ("id");
...
CREATE INDEX "wave_payment_proofs_created_at_idx" ON "public"."wave_payment_proofs" USING "btree" ("created_at" DESC);



CREATE INDEX "wave_payment_proofs_status_idx" ON "public"."wave_payment_proofs" USING "btree" ("status");



CREATE INDEX "wave_payment_proofs_user_id_idx" ON "public"."wave_payment_proofs" USING "btree" ("user_id");
...
CREATE OR REPLACE TRIGGER "trigger_update_contact_messages_updated_at" BEFORE UPDATE ON "public"."contact_messages" FOR EACH ROW EXECUTE FUNCTION "public"."update_contact_messages_updated_at"();
...
CREATE OR REPLACE TRIGGER "wave_payment_proofs_updated_at" BEFORE UPDATE ON "public"."wave_payment_proofs" FOR EACH ROW EXECUTE FUNCTION "public"."update_wave_payment_proofs_updated_at"();
...
ALTER TABLE ONLY "public"."wave_payment_proofs"
    ADD CONSTRAINT "wave_payment_proofs_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."wave_payment_proofs"
    ADD CONSTRAINT "wave_payment_proofs_validated_by_fkey" FOREIGN KEY ("validated_by") REFERENCES "auth"."users"("id");
...
CREATE POLICY "Admins can delete messages" ON "public"."contact_messages" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'admin'::"text")))));
...
CREATE POLICY "Admins can update messages" ON "public"."contact_messages" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'admin'::"text")))));
...
CREATE POLICY "Admins can update wave proofs" ON "public"."wave_payment_proofs" FOR UPDATE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."users"
...
CREATE POLICY "Admins can view all messages" ON "public"."contact_messages" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'admin'::"text")))));
...
CREATE POLICY "Admins can view all wave proofs" ON "public"."wave_payment_proofs" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."users"
  WHERE (("users"."id" = "auth"."uid"()) AND ("users"."role" = 'admin'::"text")))));
...
CREATE POLICY "Anyone can submit contact form" ON "public"."contact_messages" FOR INSERT TO "authenticated", "anon" WITH CHECK (true);
...
CREATE POLICY "Service role full access" ON "public"."wave_payment_proofs" TO "service_role" USING (true) WITH CHECK (true);
...
CREATE POLICY "Users can create own proofs" ON "public"."wave_payment_proofs" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view own proofs" ON "public"."wave_payment_proofs" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "user_id"));
...
GRANT ALL ON FUNCTION "public"."update_wave_payment_proofs_updated_at"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_wave_payment_proofs_updated_at"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_wave_payment_proofs_updated_at"() TO "service_role";
...
GRANT ALL ON TABLE "public"."wave_payment_proofs" TO "anon";
GRANT ALL ON TABLE "public"."wave_payment_proofs" TO "authenticated";
GRANT ALL ON TABLE "public"."wave_payment_proofs" TO "service_role";
